        ...
        <main className="panel" style={{ minHeight: 0 }}>
          <div className="panel__head">
            ...
            <div className="panel__head-actions">
              <button className="btn btn-subtle btn-sm" onClick={() => setPage(p => Math.max(1, p - 1))} disabled={page <= 1}>‹</button>
              <span style={{ padding: '0 8px', fontSize: 12, fontWeight: 600 }}>{page} / {generated ? totalPages : '—'}</span>
              <button className="btn btn-subtle btn-sm" onClick={() => setPage(p => Math.min(totalPages, p + 1))} disabled={!generated || page >= totalPages}>›</button>
